...
Since it was a boolean field, I created a new column called 'Holiday_Week' to convert the 'Holiday_Flag' variable from an integer to an object. Instead of showing '1' to signify a Holiday Week or '0' to signify a Non-Holiday Week, Holiday Week and Not Holiday Week will now show respectively. I then dropped the 'Holiday_Flag' variable. This will help make the data more readable and easier to understand for data visualizations.
